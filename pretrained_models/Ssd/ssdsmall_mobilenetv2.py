...
class ssdSmallMobileNetV2:
    ...
    def __init__(self, numfpga, numclus):
        ...
        self.modelpath = self.cwd_path + '/onnx_files/ssdsmall_mobilenetV2_simple_cut1.onnx'
    ...
    def forward(self, img):
        ...
        ort_session = onnxruntime.InferenceSession(self.cwd_path + 
                                                    '/onnx_files/ssdsmall_mobilenetV2_simple_cut2.onnx')
        ort_inputs = {}
    ...
    def preprocess(self, img):
        ...
        content_transform = transforms.Compose([transforms.ToTensor(), transforms.CenterCrop((300,300)),
        ...
        content_image = to_numpy(torch.transpose(content_image,1,3))    # Transpose to plane-major, as required by our API (HWC -> CHW)
